...
\begin{figure}[htbp]
  \centering
  \IfFileExists{Gambar/skripsi_image28_bw.png}{\includegraphics[width=0.72\textwidth]{skripsi_image28_bw.png}}{\fbox{System Flowchart Diagram}}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.46\textwidth}
    \centering
    \IfFileExists{Gambar/skripsi_image39.png}{\includegraphics[width=\textwidth]{skripsi_image39.png}}{\fbox{Facial Landmarks}}
  ...
  \begin{subfigure}[b]{0.46\textwidth}
    \centering
    \IfFileExists{Gambar/skripsi_image40.png}{\includegraphics[width=\textwidth]{skripsi_image40.png}}{\fbox{Lip Segmentation}}
...
\begin{figure}[htbp]
  \centering
  \IfFileExists{Gambar/skripsi_image44.png}{\includegraphics[width=0.48\textwidth]{skripsi_image44.png}}{\fbox{K-Means Visualization}}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.52\textwidth}
    \centering
    \IfFileExists{Gambar/skripsi_image45.png}{\includegraphics[width=\textwidth]{skripsi_image45.png}}{\fbox{Accuracy and Loss Graph}}
...
\begin{figure}[htbp]
  \centering
  \IfFileExists{Gambar/skripsi_image34.png}{\includegraphics[width=0.55\textwidth]{skripsi_image34.png}}{\fbox{Analysis Results Interface}}

...
R. Rousselet, 2023, ``Riverpod: A Reactive Caching and Data-Binding Framework for Flutter,'' \textit{Riverpod Documentation}, URL: \url{https://riverpod.dev/}, Abstract: Reactive state management and declarative caching framework designed for Flutter application state isolation and dependency injection., Keywords: Flutter, Riverpod, State management, Reactive caching, Dependency injection, Document Type: Online Documentation, Language: English, Database/Indexing: Riverpod, Citation Key: \texttt{remi2023riverpod}.

\bibitem{isar2024docs}
S. Leichsenring, 2024, ``Isar Database: Extremely Fast, Easy to Use, and Flexible NoSQL Database for Flutter,'' \textit{Isar Community}, URL: \url{https://isar.dev/}, Abstract: High-performance embedded NoSQL database for Flutter providing ACID compliance, offline persistence, and static typing., Keywords: Isar Database, NoSQL, Local persistence, Flutter, Offline-first, Document Type: Online Documentation, Language: English, Database/Indexing: Isar, Citation Key: \texttt{isar2024docs}.

\bibitem{supabase2024docs}
Supabase Inc., 2024, ``Supabase Documentation: PostgreSQL Row Level Security and Stored Procedures,'' \textit{Supabase Docs}, URL: \url{https://supabase.com/docs}, Abstract: Open-source Firebase alternative providing managed PostgreSQL with fine-grained Row Level Security and remote procedure calls., Keywords: Supabase, PostgreSQL, Row Level Security, RPC, Cloud backend, Document Type: Online Documentation, Language: English, Database/Indexing: Supabase, Citation Key: \texttt{supabase2024docs}.

\bibitem{pedregosa2011scikit}
F. Pedregosa, G. Varoquaux, A. Gramfort, V. Michel, B. Thirion, O. Grisel, et al., 2011, ``Scikit-learn: Machine Learning in Python,'' \textit{Journal of Machine Learning Research}, vol. 12, pp. 2825--2830, JMLR.org, ISSN: 1532-4435, URL: \url{https://jmlr.org/papers/v12/pedregosa11a.html}, Abstract: Foundational machine learning package in Python providing standardized pre-processing scalers, clustering, and regression modules., Keywords: Scikit-learn, Feature scaling, Machine learning, Python, Data mining, Document Type: Journal Article, Language: English, Database/Indexing: Scopus / JMLR, Citation Key: \texttt{pedregosa2011scikit}.

\bibitem{kingma2015adam}
D. P. Kingma and J. Ba, 2015, ``Adam: A Method for Stochastic Optimization,'' in \textit{Proc. 3rd Int. Conf. Learn. Representations (ICLR 2015)}, San Diego, CA, USA, pp. 1--15, arXiv: 1412.6980, URL: \url{https://arxiv.org/abs/1412.6980}, Abstract: Computationally efficient stochastic gradient optimization method based on adaptive estimates of lower-order moments., Keywords: Adam optimizer, Deep learning, Stochastic gradient descent, Adaptive moments, Optimization, Document Type: Conference Paper, Language: English, Database/Indexing: ICLR / arXiv, Citation Key: \texttt{kingma2015adam}.

\bibitem{srivastava2014dropout}
N. Srivastava, G. Hinton, A. Krizhevsky, I. Sutskever, and R. Salakhutdinov, 2014, ``Dropout: A Simple Way to Prevent Neural Networks from Overfitting,'' \textit{Journal of Machine Learning Research}, vol. 15, no. 56, pp. 1929--1958, JMLR.org, ISSN: 1532-4435, URL: \url{https://jmlr.org/papers/v15/srivastava14a.html}, Abstract: Regularization technique randomly dropping units during training to prevent complex co-adaptations and overfitting in deep neural networks., Keywords: Dropout, Regularization, Overfitting, Deep neural networks, Deep learning, Document Type: Journal Article, Language: English, Database/Indexing: Scopus / JMLR, Citation Key: \texttt{srivastava2014dropout}.

\bibitem{hodson2022}
T. O. Hodson, 2022, ``Root-Mean-Square Error (RMSE) or Mean Absolute Error (MAE): When to Use Them or Not,'' \textit{Geoscientific Model Development}, vol. 15, no. 20, pp. 5481--5487, Copernicus GmbH, doi: 10.5194/gmd-15-5481-2022, ISSN: 1991-9603, URL: \url{https://doi.org/10.5194/gmd-15-5481-2022}, Abstract: Mathematical and empirical comparison of MAE and RMSE metrics evaluating sensitivity to outliers and error distribution geometry., Keywords: MAE, RMSE, Error metrics, Model evaluation, Regression metrics, Document Type: Journal Article, Language: English, Database/Indexing: Scopus / Web of Science, Citation Key: \texttt{hodson2022}.
\end{thebibliography}
\endgroup

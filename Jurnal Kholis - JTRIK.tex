...
\begin{itemize}
  ...
  \item Normalisasi dan Pembentukan Sequence: Fitur numerik dinormalisasi menggunakan Min-Max Scaling ke rentang $[0, 1]$. Pembentukan sampel pembelajaran terawasi (\textit{supervised learning}) dilakukan dengan metode \textit{sliding window} berjangka pandang 7 hari aktif ($LOOK\_BACK=7$), menghasilkan dimensi masukan sekuens sebesar $7 \times 8$.

...
Dataset yang digunakan berasal dari transaksi riil kantin EatsTEDI UGM pada rentang waktu 26 Agustus 2024 hingga 21 Juni 2026 yang mencakup 314 rekaman harian dan lebih dari 94.000 baris transaksi individual. Cuplikan sampel data deret waktu penjualan harian disajikan pada Tabel \ref{tab:sample_dataset}.

\begin{table}[htbp]
  \centering
  \caption{Sampel Data Deret Waktu Penjualan Harian (EatsTEDI UGM)}
  \label{tab:sample_dataset}
  \fontsize{8pt}{10.5pt}\selectfont
  \begin{tabular}{crrrrrrc}
    \toprule
    \textbf{Tanggal} & \textbf{Omzet (Rp)} & \textbf{Trx} & \textbf{Qty} & \textbf{DOW} & \textbf{Weekend} & \textbf{Holiday} & \textbf{Ramadan} \\
    \midrule
...
Dari total rentang data tersebut, dilakukan tahapan pra-pemrosesan data sebagai berikut:
\begin{itemize}
